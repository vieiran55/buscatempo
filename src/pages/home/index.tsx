...
export default function Home({
  ...
  const valoresBeloHorizonteString = valoresBeloHorizonte.map(function (item, indice) {
    return item.toString();
  });
  ...
  return (
    <>
      <div className={estilos.corpo}>
        ...
        <div className={estilos.divisa}>
        </div>
        <div className={estilos.capitais}>
          <h1>Capitais</h1>
          <TableContainer component={Paper}>
            <Table sx={{ minWidth: 380 }} size="small" aria-label="a dense table">
              <TableHead>
                <TableRow>
